...
class ApiService {
  ...
  static async getWorkerData(username) {
    try {
      const response = await axios.get(`http://127.0.0.1:5000/get_worker_data/${username}`);
      return response.data;
    } catch (error) {
  ...
  static async getDataByTimestamp(start_time, end_time) {
    try {
      const response = await axios.get(`http://127.0.0.1:5000/get_data_by_timestamp/${start_time}/${end_time}`);
      return response.data;
    } catch (error) {
  ...
  static async getDataByWorkerAndTimestamps(worker_name, start_time, end_time) {
    try {
      const response = await axios.get(`http://127.0.0.1:5000/get_data_by_worker_and_timestamps/${worker_name}/${start_time}/${end_time}`);
      return response.data;
    } catch (error) {
  ...
  static async getWorkersAtWork(datestamp) {
    try {
      const response = await axios.get(`http://127.0.0.1:5000/get_workers_at_work/${datestamp}`);
      return response.data;
    } catch (error) {
  ...
  static async countAppearancesByTimestamp(start_time, end_time) {
    try {
      const response = await axios.get(`http://127.0.0.1:5000/count_appearances_by_timestamp/${start_time}/${end_time}`);
      return response.data;
    } catch (error) {
